...
class ExcelControl():
    ...
    def isRightSheet(self, df, team, shtName):
        ...
        '''
        math = {'slrb': {'出货时间': [True, ['出货日期', '日期', '出货日', '发货日期', '业务日期', '物流发货日期', '提货日期'], []],
...
（即货交地派时间）''', '上线时间', '新竹上线时间'], ['货交地派时间']],
                ...
                'slxmt': {'出货时间': [True, ['出货时间', 'Inbound Datetime'], []],
                        ...
                        '运单编号': [True, ['转单号', '运单号', '运单编号','Tracking ID', 'Tracking Id ', 'tracking_id', 'Tracking ID'], []],
                        '物流状态': [True, ['状态', '订单状态', 'Granular Status', 'Status', 'status'], []],
                        '状态时间': [True, ['Last Update/Scan', 'Last Delivery Date', 'Last Delivey Date', '日期', 'Latest Service End Time',
                                        'Last Valid Delivery Attempt Datetime','签收时间',
