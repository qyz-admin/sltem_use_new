...
（即货交地派时间）''', '上线时间', '新竹上线时间', '到港日期'], ['货交地派时间']],
                ...
                'gat': {'出货时间': [True, ['出货日期', '出货时间', '核重时间', '出库日期', '重出日期', '安排日期', '转寄安排日期', '發貨日期',
                                        '收件日期', '业务日期', '出库时间', '发货日期', '下单时间'], []],
                        '订单编号': [True, ['订单编号', '订单号', '订单号码', '客户单号','客人订单号', '内部单号', '原始订单号',
                                        '件號', '件号'], []],
                        '运单编号': [True, ['运单号', '新单号', '提单号', '查件单号', '重出單號', '重出单号', '重出新單號','單號',
                                        '重出新单号', '承运单号', '运单编号', '转单号码', '顺丰单号', 'SF转单号', '转单号', '转单'], []],
                        '物流状态': [True, ['物流状态', '状态', '运单最新状态', '貨態', '货态', '货态内容', '狀態', '货态详情',
                                        '新单号货态'], []],
                        '状态时间': [True, ['最新状态时间', '最新货态日期', '末条时间', '运单最新状态时间', '状态时间', '货态日期', '簽收日期',
