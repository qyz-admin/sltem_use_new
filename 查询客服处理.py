        ...
        for dir in dirs:
            ...
            if dir[:2] != '~$':
                ...
                if '换货' in dir:
                    ...
                    wb = None
                self.wbsheetHost(filePath, wb)
        print('处理耗时：', datetime.datetime.now() - start)
    # 工作表的订单信息
    def wbsheetHost(self, filePath, wb):
        ...
        if 'xls' in fileType:
            ...
            for sht in wb.sheets:
                try:
                    ...
                    print(db.columns)
                    db = db[['日期', '团队', '币种', '订单编号', '电话号码', '运单编号', '出货时间', '物流状态', '物流状态代码', '状态时间', '上线时间',
                ...
                if db is not None and len(db) > 0:
                    ...
                    db.to_sql(wb, con=self.engine1, index=False, if_exists='replace')
