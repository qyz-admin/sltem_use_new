    ...
    def order_Monitoring(self, team):        # 获取各团队各月的签收表数据 和 成本数据内容
        ...
        if match[team] == 'slgat_hfh':
            sql = '''SELECT 年月, 旬, 日期, 币种, 订单来源, a.订单编号 订单编号, 
                        ...
                        IF(b.上线时间='1990-01-01 00:00:00' or b.上线时间='1899-12-30 00:00:00' or b.上线时间='0000-00-00 00:00:00', '', IF(ISNULL(b.上线时间), a.上线时间, b.上线时间)) 上线时间, 
                        系统订单状态, 
...
if __name__ == '__main__':
    ...
    # for team in ['火凤凰台湾', '火凤凰香港', '台湾', '香港']:
    # for team in ['日本']:
    #     m.check_time(team)

    # # # 测试监控运行（三）
    # for team in ['香港', '火凤凰台湾', '火凤凰香港']:
