...
class SltemMonitoring(Settings):
    ...
    def sl_Monitoring(self, team, now_month, last_month, ready):
        ...
        start: datetime = datetime.datetime.now()
        family = ""
        if team in ('神龙-香港', '神龙-台湾', '火凤凰-香港', '火凤凰-台湾', '小虎队-香港', '小虎队-台湾', '神龙主页运营1组-台湾'):
            family = 'qsb_gat'
...
if __name__ == '__main__':
    ...
    # -----------------------------------------------监控运行的主要程序和步骤-----------------------------------------
    # 获取签收表内容（一）qsb_slgat
    last_month = '2022.01.15'
    now_month = '2022.02.15'
    ...
    # for team in ['神龙-台湾', '神龙-香港', '神龙主页运营1组-台湾', '火凤凰-台湾', '火凤凰-香港', '小虎队-台湾']:
    for team in ['神龙主页运营1组-台湾', '火凤凰-台湾', '火凤凰-香港', '小虎队-台湾']:
