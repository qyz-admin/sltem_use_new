...
-- 								IF(IF(h.`币种` = '马来西亚', 'MY', IF(h.`币种` ='菲律宾', 'PH',IF(h.`币种` = '新加坡', 'SG',h.`币种`)))) 区域,
    ...
    # 更新团队订单明细（新后台的）
    def orderInfo(self, tokenid, searchType, team):  # 进入查询界面，
        print('正在获取需要订单信息')
        start = datetime.datetime.now()
...
if __name__ == '__main__':
    ...
    #   日本token：5b8fa0b2dd75148885f5fe775f4da686
    #   台湾token：377a056df2aa3859689b4b2a5af8fe01
    #   新马token：a4d7c34a2c1fa6807e2cf80d79e894c9
    #   泰国token：5b8fa0b2dd75148885f5fe775f4da686