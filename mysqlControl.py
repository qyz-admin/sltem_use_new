...
class MysqlControl(Settings):
    ...
    def creatMyOrderSl(self, team, begin, end) :  # 最近五天的全部订单信息
        match = {'gat': '"神龙家族-港澳台", "红杉家族-港澳台2", "金狮-港澳台", "红杉家族-港澳台", "火凤凰-港澳台", "火凤凰-港台(繁体)", "金鹏家族-4组", "神龙-运营1组", "奥创队", "客服中心-港台","研发部-研发团队","Line运营", "神龙-主页运营", "翼虎家族-mercadolibre","金蝉家族1组","金蝉家族2组","金蝉项目组","APP运营"',
